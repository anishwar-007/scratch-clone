      ...
      <div className="flex justify-between mb-10">
        ...
        <div>
          <div
            ...
            className={`flex rounded-full mx-auto bg-gradient-to-tr from-violet-400 to-green-400 p-1 shadow-lg ${classes.button}`}
          >
            <button
              className="flex-1 md:text-xl bg-green px-2 py-1 rounded-full"
